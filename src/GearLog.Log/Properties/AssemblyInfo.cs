...
using BuildInfo = GearLog.Log.BuildInfo;
...
[assembly: MelonInfo(typeof(GearLog.Log.Main), BuildInfo.GUIName, BuildInfo.Version, BuildInfo.Author, BuildInfo.DownloadLink)]
