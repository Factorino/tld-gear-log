...
using BuildInfo = GearLog.UI.BuildInfo;
...
[assembly: MelonInfo(typeof(GearLog.UI.Main), BuildInfo.GUIName, BuildInfo.Version, BuildInfo.Author, BuildInfo.DownloadLink)]
